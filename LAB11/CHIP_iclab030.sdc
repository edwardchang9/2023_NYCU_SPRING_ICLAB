...
set_input_delay -clock clk  5  [get_ports in_valid2]
set_input_delay -clock clk  5  [get_ports matrix]
set_input_delay -clock clk  5  [get_ports {matrix_size[1]}]
set_input_delay -clock clk  5  [get_ports {matrix_size[0]}]
set_input_delay -clock clk  5  [get_ports i_mat_idx]
set_input_delay -clock clk  5  [get_ports w_mat_idx]
set_output_delay -clock clk  5  [get_ports out_valid]
set_output_delay -clock clk  5  [get_ports out_value]
